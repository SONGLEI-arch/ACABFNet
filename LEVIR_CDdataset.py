...
# root_path = r'D:\ChangeDetection\LEVIR-CD\after_remove256x256crop'

def read_images():
    imgs_Atrain = glob.glob(r'F:\LEVIR_dataset\train' + '\\A\\*.png')
    imgs_Btrain = glob.glob(r'F:\LEVIR_dataset\train' + '\\B\\*.png')
    labelstrain = glob.glob(r'F:\LEVIR_dataset\train' + '\\label\\*.png')
    imgs_Atest = glob.glob(r'F:\LEVIR_dataset\test' + '\\A\\*.png')
    imgs_Btest = glob.glob(r'F:\LEVIR_dataset\test' + '\\B\\*.png')
    labelstest = glob.glob(r'F:\LEVIR_dataset\test' + '\\label\\*.png')
